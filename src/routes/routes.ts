...
const models: TsoaRoute.Models = {
    "RefreshResponse": {
        "dataType": "refObject",
        "properties": {
            "newAccessToken": {"dataType":"string"},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsRefreshController_refresh: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.post('/auth/refresh',
            ...
            async function RefreshController_refresh(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsRefreshController_refresh, request, response });
